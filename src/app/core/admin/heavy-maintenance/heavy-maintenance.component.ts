...
@Component({
  selector: "app-heavy-maintenance",
  templateUrl: "./heavy-maintenance.component.html",
  styleUrls: ["./heavy-maintenance.component.scss"],
})
export class HeavyMaintenanceComponent implements OnInit, OnDestroy {
  // Chart
  chart: any;
